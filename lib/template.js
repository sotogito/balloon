  ...
  HTML:function(title,bal, list, body, control){
    ...
    <head>
      ...
      <style>
        ...
        .page_button > form > p > input:hover{
    ...
    `;
  },balloon:function(logo,text1,pic){
    return `
    <!doctype html>
    ...
    return `
      <select name="author" style="color:green;font-weight: 600;" >
      ${tag}
      </select>
    `;
  }
